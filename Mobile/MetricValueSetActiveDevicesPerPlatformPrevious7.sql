--Implemented At: https://admin.oneandall.church/reporting/metrics?MetricCategoryId=89&ExpandedIds=C758%2CC596
-- Tracked At: Mobile/MetricValueSetActiveDevicesPerPlatformPrevious7.sql
...
INNER JOIN Interaction i ON i.InteractionDateTime BETWEEN DATEADD(d, -6, asd.[Date]) AND DATEADD(d, 1, asd.[Date])
